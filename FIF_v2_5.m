function [IMF,logM,stats] = FIF_v2_5(f,options,M)


%
%  function IMF = FIF_v2_4(f,options)
%
...
if nargin < 1,  help FIF_v2_4; return; end
...
%         set(figMask,'Units', 'Normalized', 'OuterPosition', [0 0 1 1]);
    ...
    if options.saveInter==1
        save([nameFile '_intermediate_FIF_v2_4.mat'],'IMF','f','logM','-v7.3');
    end
end %end of while
...
if options.saveEnd == 1
    save([ 'Final_' nameFile '_FIF_v2_4.mat'],'IMF','logM','-v7.3');
end
